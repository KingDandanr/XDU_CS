...
HD_PWD='E:/SWQ/run_led/run_led.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log run_led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source run_led.tcl -notrace
