...
begin
    case state is
    when s0=>seg_sel<="0000";data_in_line<=data_in_A(3 downto 0);next_state<=s1;
    when s1=>seg_sel<="0001";data_in_line<=data_in_A(7 downto 4);next_state<=s2;
    when s2=>seg_sel<="0010";data_in_line<=data_in_A(11 downto 8);next_state<=s3;
    when s3=>seg_sel<="0011";data_in_line<=data_in_A(15 downto 12);next_state<=s4;
