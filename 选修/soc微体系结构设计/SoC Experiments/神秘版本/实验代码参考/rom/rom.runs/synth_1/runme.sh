...
HD_PWD='C:/Users/akyna/Codes/vivado/rom/rom.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_dled.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_dled.tcl
