...
HD_PWD='C:/Users/akyna/Codes/vivado/rom/rom.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_dled.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rom_dled.tcl -notrace
