...
HD_PWD='C:/Users/akyna/Codes/vivado/experiment1/test19/test19.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log timper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source timper.tcl -notrace
