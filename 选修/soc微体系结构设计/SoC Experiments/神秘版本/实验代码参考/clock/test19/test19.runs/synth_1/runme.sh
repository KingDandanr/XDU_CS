...
HD_PWD='C:/Users/akyna/Codes/vivado/experiment1/test19/test19.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log timper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source timper.tcl
