...
HD_PWD='C:/Users/akyna/Codes/vivado/SP/SP/SP/SP.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sp_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sp_top.tcl -notrace
