...
HD_PWD='C:/Users/akyna/Codes/vivado/experiment1/test2/test2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log parellel_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source parellel_adder.tcl -notrace
