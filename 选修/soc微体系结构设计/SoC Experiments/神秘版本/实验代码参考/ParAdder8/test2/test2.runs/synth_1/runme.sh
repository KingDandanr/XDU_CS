...
HD_PWD='C:/Users/akyna/Codes/vivado/experiment1/test2/test2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log parellel_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source parellel_adder.tcl
