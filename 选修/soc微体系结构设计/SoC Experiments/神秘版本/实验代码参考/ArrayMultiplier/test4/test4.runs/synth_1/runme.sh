...
HD_PWD='C:/Users/akyna/Codes/vivado/experiment1/test4/test4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mul8_c.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mul8_c.tcl
