...
HD_PWD='C:/Users/akyna/Codes/vivado/experiment1/test4/test4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mul8_c.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mul8_c.tcl -notrace
