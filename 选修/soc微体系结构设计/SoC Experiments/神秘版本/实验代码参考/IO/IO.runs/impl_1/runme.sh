...
HD_PWD='C:/Users/akyna/Codes/vivado/IO/IO/IO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log IO_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source IO_top.tcl -notrace
