...
HD_PWD='C:/Users/akyna/Codes/vivado/shumaguan/shumaguan.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design1.tcl -notrace
