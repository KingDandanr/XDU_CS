...
HD_PWD='C:/Users/akyna/Codes/vivado/IR/IR_storge/IR_storge/IR_storge.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log IR.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source IR.tcl -notrace
