        ...
        when s5 =>
         if(k_in(5) = '1') then
          seg_sel <= "1111111111011111";
             seg_data <="11111000";--10010010表示5   --7
         end if;
          next_state <= s6;
        ...
        when s8 =>
         if(k_in(8) = '1') then
          seg_sel <= "1111111011111111";
             seg_data <="11000000";--10000000表示8  --0
          end if;
          next_state <= s9;
        ...
        when s10 =>
         if(k_in(10) = '1') then
          seg_sel <= "1111101111111111";
             seg_data <="11111001";--10001000表示A  --1
         end if;
          next_state <= s11;
        ...
        when s11 =>
         if(k_in(11) = '1') then
          seg_sel <= "1111011111111111";
             seg_data <="11000000";--10000011表示b  --0
         end if;
          next_state <= s12;
        ...
        when s12 =>
         if(k_in(12) = '1') then
          seg_sel <= "1110111111111111";
             seg_data <="10110000";--11000110表示c --3
         end if;
          next_state <= s13;
