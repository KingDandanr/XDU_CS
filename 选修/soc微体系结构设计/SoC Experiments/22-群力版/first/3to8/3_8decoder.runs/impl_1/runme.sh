...
HD_PWD='D:/SOC/kyle/3_8decoder/3_8decoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder3_8_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source decoder3_8_tb.tcl -notrace
