...
HD_PWD='D:/SOC/kyle/3_8decoder/3_8decoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder3_8_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decoder3_8_tb.tcl
