...
HD_PWD='C:/Users/Administrator/Desktop/SOC_trial/ARRAYMUL/ARRAYMUL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log array_multiplier_seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source array_multiplier_seg.tcl
