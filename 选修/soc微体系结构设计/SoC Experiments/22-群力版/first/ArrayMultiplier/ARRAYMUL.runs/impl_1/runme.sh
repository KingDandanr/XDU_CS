...
HD_PWD='C:/Users/Administrator/Desktop/SOC_trial/ARRAYMUL/ARRAYMUL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log array_multiplier_seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source array_multiplier_seg.tcl -notrace
