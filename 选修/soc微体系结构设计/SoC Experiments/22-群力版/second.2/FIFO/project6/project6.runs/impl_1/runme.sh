...
HD_PWD='C:/Users/Administrator/Desktop/FIFO/project6/project6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FIFOControl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FIFOControl.tcl -notrace
