...
HD_PWD='C:/Users/Administrator/Desktop/FIFO/project6/project6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIFOControl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIFOControl.tcl
