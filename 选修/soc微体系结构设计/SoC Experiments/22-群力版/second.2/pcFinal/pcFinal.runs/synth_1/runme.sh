...
HD_PWD='C:/Users/Administrator/Desktop/vivado/vivado/pcFinal/pcFinal.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pcFinal.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pcFinal.tcl
