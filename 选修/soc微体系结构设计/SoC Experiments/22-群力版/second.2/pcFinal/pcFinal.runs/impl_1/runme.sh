...
HD_PWD='C:/Users/Administrator/Desktop/vivado/vivado/pcFinal/pcFinal.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pcFinal.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pcFinal.tcl -notrace
